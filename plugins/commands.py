...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [
            [InlineKeyboardButton('💝 ᴏᴜʀ ᴍᴏᴠɪᴇs ᴄʜᴀɴɴᴇʟ', url='https://t.me/+E60y6hIjVSoxOWI1')],
            [InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/cine_huntsupdates')],
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            title = '@cine_huntsupdates  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
